...
////////////////////////////////////////////////////////////////////////////////////////////////////////
// Agregamos variables y métodos nuevos a CBinTree
class CBinTree {
public:
    CBinTree();
    bool Insert(int x);
...
private:
    ...
    // Métodos auxiliares para la construcción paralela
...
// Método para construir una sección del árbol (lo ejecutará cada thread)
...
void CBinTree::buildTreeParallel(int* leafs, int size) {
    ...
    // Creamos 4 threads, cada uno construyendo una parte del árbol
    for (int i = 0; i < 4; i++) {
    ...
    // Unimos los resultados en pares
...
int main() {
    ...
    // Construimos el árbol usando 4 threads
